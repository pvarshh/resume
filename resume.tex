...
\textbf{\$500,000} annualy in loan defects; in testing}
            \resumeItem{Migrating UWM databases to Google Cloud 
Platforming services; simultaneously writing \textbf{Python} \& 
\textbf{SQL} scripts to monitor business access to GCP, flagging 
inefficiency or overuse of GCP resulting in finance loss with finance 
team}
          \resumeItemListEnd
