...
\section{Programming Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    ...
    %\textbf{Concepts}{: Core Operating Systems, Database Management, 
Machine Learning, Algorithms, Optimization Programming}

     \textbf{Languages}{: C++, C, C\#, Python, Java, R/RStudio, HTML/CSS, 
Javascript, SQL, LaTeX, Bash Script} $ $

     \textbf{Technologies}{: Linux, Git, nano, nvim, MacOS, Windows, JIRA, 
Agile, Docker, Dynatrace, .NET, Tableau} $ $
...
% -------------------- TECH EXPERIENCE --------------------
 \section{Technical Experience}
  \resumeSubHeadingListStart
          ...
          \resumeItemListStart
            \resumeItem{Piloting a change insights \textbf{datamart} in 
